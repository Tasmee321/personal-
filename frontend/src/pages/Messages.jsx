    ...
    <div style={{ minHeight: '100vh', backgroundColor: theme.bg, color: theme.text }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          <span style={{ fontWeight: 'bold', fontSize: '16px' }}>{t('messages.title')}</span>
          {unreadCount > 0 && (
            <span style={{
      ...
      <div style={{ padding: '20px', maxWidth: '520px', margin: '0 auto' }}>
        {!loading && messages.length === 0 && (
          <div style={{ textAlign: 'center', padding: '50px 0' }}>
            ...
            <p style={{ color: theme.faint, fontSize: '14px', margin: 0 }}>{t('messages.emptyYet')}</p>
          </div>
        )}
        ...
        {messages.map((m) => (
          <button
            ...
            style={{
              width: '100%', display: 'flex', gap: '12px', padding: '16px', textAlign: isRTL ? 'right' : 'left',
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                ...
                {!m.read && <span style={{ width: '7px', height: '7px', borderRadius: '50%', backgroundColor: theme.down, flexShrink: 0, marginTop: '5px', [isRTL ? 'marginRight' : 'marginLeft']: '8px' }} />}
              </div>
